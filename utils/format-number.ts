...
export function abbreviateNumber(num: number | bigint | null | string): string {
    ...
    const bigNum = num; // Convert to BigInt to ensure precision

    if (bigNum >= 1_000_000_000_000_000_000) {
        return `${(bigNum / 1_000_000_000_000_000_000).toString()}q`;
    } else if (bigNum >= 1_000_000_000_000_000) {
        return `${(bigNum / 1_000_000_000_000_000).toString()}p`;
    } else if (bigNum >= 1_000_000_000_000) {
        return `${(bigNum / 1_000_000_000_000).toString()}t`;
    } else if (bigNum >= 1_000_000_000) {
        return `${(bigNum / 1_000_000_000).toString()}b`;
    } else if (bigNum >= 1_000_000) {
        return `${(bigNum / 1_000_000).toString()}m`;
    } else if (bigNum >= 1_000) {
        return `${(bigNum / 1_000).toString()}k`;
    } else {
